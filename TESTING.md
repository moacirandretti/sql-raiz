...
3. Faça merge de um PR com título contendo palavra-chave
4. Verifique:
   - Nova tag criada
...
2. Você verá dois workflows:
   ...
   - "Publish Extension" - executado apenas em master/main
...
- Verifique se está na branch master/main
...
node -e "
const { determineVersionType, incrementVersion } = require('./scripts/bump-version.js');
